            ...
            <table class="table table-striped table-hover mb-none">
                ...
                <thead class="table-dark">
                    <tr class="orders">
                        ...
                        <th scope="col">
                            <div class="d-flex bd-highlight">
                                Subtotal<i class="bi bi-sort-down ms-auto"></i>
                                <!-- <input type="hidden" name="subtotalOrder" id="subtotalOrder" value="desc"> -->
                            </div>
                        </th>
                        <th scope="col">
                            <div class="d-flex bd-highlight">
                                Total<i class="bi bi-sort-down ms-auto"></i>
                                <!-- <input type="hidden" name="totalOrder" id="totalOrder" value="desc"> -->
                            </div>
                        </th>
                        <th scope="col">
                            <div class="d-flex bd-highlight">
                ...
                <thead>
                    ...
                    <th scope="col">
                        ...
                        <th scope="col">
                            <input placeholder="$" type="number" class="form-control" name="subtotalFilter" id="subtotalFilter">
                        </th>
                        <th scope="col">
                ...
                <tfoot class="table-dark">
                    <tr>
                        ...
                        <td colspan="2">
                            <span class="d-flex bd-highlight text-left" id="subtotal"></span>
                        </td>
                        <td colspan="1">
                            Total
                        </td>
