...
<html lang="en">
  <head>
    ...
    <!-- <script src="https://cdn.jsdelivr.net/npm/jquery.ui.datepicker-es@0.6.2/jquery.ui.datepicker-es.min.js"></script> -->
    ...
    <link rel="icon" href="./extras/quarz-logo.png">
    ...
    <!-- Includes Externos-->
    <?php echo $this->boostrap_includes_cdn ?>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="">
            <img class="d-block mx-auto" src="./extras/quarz-logo.png" alt="" width="40" height="50">
          </a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
              ...
              <li>
                <a href="./closeSession" class="nav-link text-white">
                  <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#forward"></use></svg>
                  Cerrar Sesión
                </a>
              </li>
            </ul>
